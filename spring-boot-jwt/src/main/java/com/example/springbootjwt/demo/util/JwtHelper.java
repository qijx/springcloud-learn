package com.example.springbootjwt.demo.util;

import com.alibaba.fastjson.JSONObject;
import com.example.springbootjwt.demo.constant.SecretConstant;
import com.example.springbootjwt.demo.secret.AESSecretUtil;
...
public class JwtHelper {
    ...
    /**
     * 博客地址：https://blog.csdn.net/weixin_42873937/article/details/82460997
     * @Author: Helon
    ...
    public static String validateLogin(String jsonWebToken) {
        ...
        if (claims != null) {
            ...
            /**
             * 刷新JWT,每次刷新token的作用是为了让token的失效时间从当前一次请求开始算，
             * 比如在第29分钟的时候请求了一个接口，拦截器拦截请求并调用检验token的方法，
             * 那么会返回给前端一个最新的token失效时间还是30分钟
             */
