package com.example.scqijx.controller;

import com.example.scqijx.domain.User;
import com.example.scqijx.service.UserService;
...
public class TestController {
    ...
    public String getActivityList(@PathVariable String name, Map<String, Object> module){
        User user = userService.getUserByName(name);
        module.put("user", user);
        return "testhtml/hellow";
    }
